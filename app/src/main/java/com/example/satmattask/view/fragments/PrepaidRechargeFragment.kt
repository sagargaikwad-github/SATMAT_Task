...
import com.example.satmattask.databinding.FragmentPrepaidRechargeBinding
...
class PrepaidRechargeFragment : Fragment() {
    private lateinit var binding: FragmentPrepaidRechargeBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPrepaidRechargeBinding.inflate(layoutInflater)
        ...
        viewModel.getOperatorResponse.observe(viewLifecycleOwner, Observer {
            ...
            when (it) {
                ...
                is ResponseSealed.Error -> {
                    Utils.showToast(requireContext(), it.error?.message!!)
                }
            }
        ...
        binding.apply {
            ...
            prepaidBrowsePlanBTN.setOnClickListener {
                ...
                val getOperator = prepaidRechargeChooseOperator.text.toString()
    ...
    private fun selectedRecharge(amount : String)
    {
        ...
        binding.prepaidRechargeAmountTV.setText(amount.toString())
    }
}